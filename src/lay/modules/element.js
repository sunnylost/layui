...
layui.define('jquery', function(exports) {
    ...
    Element.prototype.tabAdd = function(filter, options) {
        let TITLE = '.layui-tab-title',
            ...
            li =
                '<li lay-id="' + (options.id || '') + '">' + (options.title || 'unnaming') + '</li>'
    ...
    let NAV_ELEM = '.layui-nav',
        ...
        call = {
            ...
            clickThis: function() {
                ...
                if (
                    !(elemA.attr('href') !== 'javascript:;' && elemA.attr('target') === '_blank') &&
                    !unselect
                ) {
            ...
            collapse: function() {
                ...
                if (typeof parents.attr('lay-accordion') === 'string') {
                    let show = parents.children('.layui-colla-item').children('.' + SHOW)
                    show
    ...
    Element.prototype.init = function(type, filter) {
        let elemFilter = filter ? '[lay-filter="' + filter + '"]' : '',
            items = {
                //Tab选项卡
                tab: function() {
                    call.tabAuto.call({})
                ...
                nav: function() {
                    let TIME = 200,
                        ...
                        follow = function(bar, nav, index) {
                            ...
                            if (nav.hasClass(NAV_TREE)) {
                                ...
                                bar.css({
                                    left:
                                        othis.position().left + parseFloat(othis.css('marginLeft')),
                    ...
                    $(NAV_ELEM + elemFilter).each(function(index) {
                        ...
                        itemElem.each(function() {
                            ...
                            oitem
                                .children('a')
                                .off('click', call.showChild)
                                .on('click', call.showChild) //展开二级菜单
                            child
                                .children('dd')
                                .off('click', call.clickChild)
                                .on('click', call.clickChild) //点击子菜单选中
                        })
                    })
                },
                ...
                //折叠面板
                collapse: function() {
                    let ELEM = 'layui-collapse'

                    $('.' + ELEM + elemFilter).each(function() {
                        let elemItem = $(this).find('.layui-colla-item')
