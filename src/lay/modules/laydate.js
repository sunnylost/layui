    ...
    */
    ...
    Class.prototype.init = function() {
        ...
        lay.each(that.format, function(i, item) {
            ...
            let EXP = new RegExp(dateType).test(item) ? '\\d{' + result + '}' : '\\' + item
        ...
        options.mark = lay.extend(
            {},
            options.calendar && options.lang === 'cn' ? chinaHolidays : {},
            options.mark
        )
    ...
    Class.prototype.checkDate = function(fn) {
        let that = this,
            ...
            value = that.isInput(elem)
                ? elem.value
                : options.position === 'static' ? '' : elem.innerHTML,
            //校验日期有效数字
    ...
    Class.prototype.choose = function(td) {
        ...
        if (options.range) {
            ...
            let $confirm = lay(that.footer).find(ELEM_CONFIRM)
